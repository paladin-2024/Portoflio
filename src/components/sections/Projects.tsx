...
const projects = [
  ...
  },
  {
    ...
    shortDesc: 'Digital fish trading platform for Jonglei state, South Sudan.',
    desc: 'End-to-end fish trade management platform for Jonglei state, South Sudan. Fish traders, buyers, transporters and border officials all operate through a Flutter mobile app and a full React web admin dashboard. Features live market prices across 6 cities, border clearance workflows, GPS shipment tracking and a real-time analytics engine.',
    metric: '200+ traders · 14 markets · 38 routes',
    highlights: [
      'Flutter mobile: Home, Market listings, Shipments, Messages & Profile',
      'Admin dashboard: Listings, Orders, Market Prices, Clearance & Analytics',
      'Live price ledger across Bor, Juba, Wau, Malakal, Renk and more',
      'Border clearance queue and shipment tracking with live map',
    ],
  ...
  },
  {
    num: '06',
    title: 'IUEA Library',
    shortDesc: 'AI-powered digital academic library for IUEA students & faculty.',
    desc: 'Full digital library platform for the International University of East Africa, giving students and faculty access to 500,000+ resources. Read, listen via text-to-speech, stream academic podcasts, or borrow physical copies — all from one screen. Includes a Gemini-powered AI assistant for research navigation, faculty collections, reading goals and engagement streaks.',
    metric: '500,000+ resources · Gemini AI assistant',
    highlights: [
      'Read, listen (TTS), download or borrow physical copies from one screen',
      'Gemini AI assistant — answers research and library navigation queries',
      'Academic podcast streaming with faculty lectures and series',
      'Faculty collections, reading goals, streaks & smart notifications',
    ],
